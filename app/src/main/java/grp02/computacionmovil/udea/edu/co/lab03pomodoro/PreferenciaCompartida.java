...
public class PreferenciaCompartida {
    ...
    public void setCorto(Context context, int corto){
        switch (corto){
            case 0:
<<<<<<< HEAD
                setCortoTiempo(context,180);
                break;
            case 1:
                setCortoTiempo(context,240);
                break;
            case 2:
                setCortoTiempo(context,300);
=======
...
>>>>>>> 2fa03efb97d00318a3e28da00b010c2841dbc13c
    ...
    public int getCortoTiempo(Context context){
        SharedPreferences preferences = getSharedPreferences(context);
<<<<<<< HEAD
        return preferences.getInt("cortoTiempo", 180);
=======
...
>>>>>>> 2fa03efb97d00318a3e28da00b010c2841dbc13c
    ...
    public void setLargo(Context context, int largo){
        switch (largo){
            case 0:
<<<<<<< HEAD
                setLargoTiempo(context,600);
                break;
            case 1:
                setLargoTiempo(context,900);
                break;
            case 2:
                setLargoTiempo(context,1200);
=======
...
>>>>>>> 2fa03efb97d00318a3e28da00b010c2841dbc13c
    ...
    public int getLargoTiempo(Context context){
        SharedPreferences preferences = getSharedPreferences(context);
<<<<<<< HEAD
        return preferences.getInt("largoTiempo", 600);
=======
...
>>>>>>> 2fa03efb97d00318a3e28da00b010c2841dbc13c
    ...
    public int getPomodoro(Context context){
        SharedPreferences preferences = getSharedPreferences(context);
<<<<<<< HEAD
        return preferences.getInt("pomodoro", 1500);
=======
